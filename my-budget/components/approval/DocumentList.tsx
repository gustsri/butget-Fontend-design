        ...
        <div className="space-y-4">
            {documents.length === 0 ? (
                <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-medium text-gray-900 mb-2">ไม่มีเอกสารที่รออนุมัติ</h3>
                    <p className="text-gray-500">ขณะนี้ไม่มีเอกสารที่ต้องรออนุมัติในระบบ</p>
                </div>
            ) : (
                            ...
                            <div className="flex-1">
                                ...
                                <div className="mt-4 pt-3 border-t border-gray-100">
                                    <div className="flex items-center justify-between text-xs text-gray-500">
                                        ...
                                        <span>รหัสเอกสาร: DOC-{document.id.toString().padStart(4, '0')}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
